...
- **Monthly:** `product-strategist` reviews this doc against the dashboards. Any event with zero usage in the last 30 days gets deleted (from both this doc and `events.ts`).
