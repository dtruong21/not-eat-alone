...
- **Privacy policy URL**: {{from .env EXPO_PUBLIC_PRIVACY_URL}}
- **Terms of service URL**: {{from .env EXPO_PUBLIC_TERMS_URL}}
...
5 screens per platform, captured from a dev build (NOT Expo Go).
