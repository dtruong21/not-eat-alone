...
**Commands** — workflow: `/idea /spec /design /build /test /release` · micro: `/scope-check /bug /next /qa-sweep /weekly-review` · scaffold: `/firestore /provider /track` · release+marketing: `/bump /aso /launch`. Index: `.claude/commands/README.md`. **Prefer commands over re-typing prompts.**
